export const data = [
  {
    title: "MERN Project",
    description:
      "E-commerce Project that use MongoDB, Mongoose, Express, Handlesbars, NodeJS and Bootstrap. Actually, it's a ME-H-N project. I decided use Handlebars because i've experience using ReactJs.",
    thumbnail:
...

  {
    ...
    description:
      "ReactJs Project that use Bootstrap and React. Consume data from Google Firebase.",
    thumbnail:
...

  {
    ...
    description:
      "A simple web page for Hara Equilibrio that offer their clothes.",
    thumbnail:
